...
lottie_coding = load_lottiurl("https://lottie.host/827823ff-5ea9-4bc9-9cdd-eb7da9919c3f/g0cyw6CSGC.json")
nlp = Image.open("images/nlp.PNG")
dash = Image.open("images/dash.PNG")
twitter = Image.open("images/Capture.PNG")
